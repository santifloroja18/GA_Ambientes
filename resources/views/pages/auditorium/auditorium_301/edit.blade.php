                            ...
                            <div class="modal-body">
                                <form action="{{route('auditorium.update',$data)}}" method="POST">
                                    ...
                                    <div class="navegacion-btn-edit">
                                        <a class="btnn-style a" href="{{route('reservas-auditorio-301')}}">Regresar</a>
                                        @can('auditoriumTres.edit')
                                            <input class="btn btnn-style" type="submit" value="Editar Reserva">
                                        @endcan
                                    </div>
                                </form>
                                @can('auditoriumTres.destroy')
                                    <form action="{{route('auditoriumTres.destroy',$data)}}" method="POST">
                                        @csrf
                                        @method('DELETE')
